...
export default function Navbar() {
  ...
  return (
    <>
        ...
        <nav aria-label="main navigation menu">
                ...
                {useAuthStatus() ? (
                  <>
                    <form action={async () => {
                      ...
                      <button aria-pressed="true" aria-label="logout button" type="submit" className="flex items-center">
            ...
            <ul className="xl:hidden flex items-center flex-initial sm:w-1/2 w-1/3 justify-end gap-5">
              ...
              <li>
                {useAuthStatus() ? (
                  ...
                  <>
                    {/* TODO: tes tampilnya di mana ini */}
                    <NavLinks aria-label="login button" icon={faUser} href="/login" customCls="lg:text-sm sm:text-xs text-sm text-bs-secondary--lighter hover:text-bs-secondary--darker flex items-center" />
                  </>
                )}
              </li>
            </ul>
          ...
          < div className="flex items-center lg:px-10 sm:px-[30px] px-5 lg:py-2 py-1 bg-white relative" >
            ...
            <div className="sm:hidden absolute right-5 ">
              <button aria-pressed="true" aria-label="sidebar open button" onClick={toggleSideMenu}>
      ...
      <aside role="navigation" id="aside" className="bg-bs-primary--darker p-5 w-full h-full fixed overflow-hidden z-10 sm:hidden -left-full">
        <div className="flex justify-end">
          <button aria-pressed="true" aria-label="sidebar close button" onClick={toggleSideMenu}>
        ...
        <div>
          ...
          <div className="absolute inset-x-5 flex justify-center bottom-5">
            <div>
              {/* TODO: coba tes ketika ini katif gimana tampilannya */}
              {/* <nav aria-label="main navigation menu"> */}
