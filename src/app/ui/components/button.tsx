  ...
  return (
    <>
      {btnType == "btn-group" ? (
        ...
        <Link href={contacts[2].href} className="bg-bs-secondary border-2 border-bs-secondary text-bs-primary--darker !font-bold lg:text-base sm:text-sm text-xs lg:py-4 sm:py-3 py-2 lg:px-16 sm:px-[42px] px-8 hover:bg-bs-secondary--darker hover:border-transparent">Order Now</Link>
      )
      }
    </>
  )
